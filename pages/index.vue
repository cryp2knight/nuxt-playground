<template>
  <div
    v-if="loader"
    class="z-50 left-0 top-0 w-full h-full justify-center flex flex-col items-center fixed bg-white"
  >
    <div class="flex justify-center">
      ...
      >
        <g>
          ...
          <g>
            <path
              fill="none"
              d="M702.832,415.56c0,79.646-32.563,148.996-80.661,184.96c-85.131-1.604-153.768-95.524-153.768-211.148
			c0-79.646,32.577-149.01,80.675-184.974C634.195,206.003,702.832,299.936,702.832,415.56z"
            />
            <path
              fill="#31353E"
              d="M468.403,389.372c0-79.646,32.577-149.01,80.675-184.974c-0.74,0-1.468-0.014-2.208-0.014
          ...
          <path
            fill="#EB545D"
            d="M817.963,453.622c0-208.447-114.939-377.434-256.723-377.434c-141.771,0-256.709,168.987-256.709,377.434
		...
		s69.829-211.175,155.975-211.175c86.132,0,155.962,94.55,155.962,211.175S633.003,626.722,546.87,626.722z"
          ...
          <path
            fill="none"
            d="M638.764,204.385c-86.146,0-155.975,94.55-155.975,211.175s69.829,211.162,155.975,211.162
      ...
      <span
        class="font-semibold text-3xl text-red-600 animate-pulse"
        style="font-family: Arial, sans-serif"
        >Layas</span
      >
      <span class="w-4 h-4 bg-black rounded-full animate-ping"> </span>
    </div>
    <span
      style="font-family: Arial, sans-serif"
      class="text-sm text-gray-500 text-center"
      >Your number one travel partner</span
    >
  </div>
  <div v-else class="flex flex-col items-center mx-5 mt-8">
    <Registration />
    <Home />
  </div>
</template>
